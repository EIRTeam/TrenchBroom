...
/**
 * Defines the type of a vertex by the types of the vertex attributes. Enables to set up and clean
 * up the corresponding vertex buffer pointers.
 *
...
/**
 * Template specialization of the GLVertexType template for the case of multiple vertex attributes.
 * The first attribute is handled in this template, while the remaining attributes are delegated
 * recursively.
 *
...
struct GLVertexType<AttrType, AttrTypeRest...> {
  ...
  /**
   * Sets up the vertex buffer pointer for the first vertex attribute type and delegates the call
   * for the remaining attribute types. Do not call this directly, use the setup method instead.
   *
   * @param program current shader program
  ...
  /**
   * Cleans up the vertex buffer pointer for the first vertex attribute type and delegates the call
   * for the remaining attribute types. Do not call this directly, use the cleanup method instead.
   *
...
/**
 * Template specialization of the GLVertexType template for the case of a single vertex attributes.
 * This is the base case for the recursive calls in the multi-attribute GLVertexType specialization
 * above.
 *
 * @tparam AttrType the type of the vertex attribute
 */
template <typename AttrType> struct GLVertexType<AttrType> {
  ...
  /**
   * Sets up the vertex buffer pointer for the vertex attribute type. Do not call this directly, use
  ...
  /**
   * Cleans up the vertex buffer pointer for the vertex attribute type. Do not call this directly,
   * use the cleanup method instead.
   *
   * @param program current shader program
   * @param index the index of the attribute to be cleaned up here
   */
...
using P2T2C4 =
  GLVertexType<GLVertexAttributeTypes::P2, GLVertexAttributeTypes::T02, GLVertexAttributeTypes::C4>;
using P3T2C4 =
  GLVertexType<GLVertexAttributeTypes::P3, GLVertexAttributeTypes::T02, GLVertexAttributeTypes::C4>;
...
using P3NT2C4 =
  GLVertexType<GLVertexAttributeTypes::P3, GLVertexAttributeTypes::N, GLVertexAttributeTypes::T02, GLVertexAttributeTypes::C4>;
} // namespace GLVertexTypes
} // namespace Renderer
} // namespace TrenchBroom
